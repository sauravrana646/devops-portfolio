...
export function GitOpsHubSpokeDiagram({ title = "GitOps hub and spoke", ...props }: DiagramProps) {
  return (
    <svg viewBox="0 0 900 320" role="img" aria-label={title} {...props}>
      <rect width="900" height="320" fill="#F7FAF8" rx="16" />
      <rect x="40" y="120" width="160" height="80" rx="16" fill="#ffffff" stroke="#9DB8A8" strokeWidth="2" />
      <text x="120" y="155" fill="#243038" fontSize="14" textAnchor="middle" fontFamily={font}>
        Argo CD Hub
      </text>
      <text x="120" y="175" fill="#6B7C82" fontSize="11" textAnchor="middle" fontFamily={font}>
        mgmt cluster
      </text>
      <rect x="370" y="40" width="140" height="70" rx="14" fill="#EEF5F1" stroke="#C5D9CC" strokeWidth="2" />
      <text x="440" y="80" fill="#3D4F58" fontSize="13" textAnchor="middle" fontFamily={font}>
        Cluster A
      </text>
      <rect x="370" y="130" width="140" height="70" rx="14" fill="#EEF5F1" stroke="#C5D9CC" strokeWidth="2" />
      <text x="440" y="170" fill="#3D4F58" fontSize="13" textAnchor="middle" fontFamily={font}>
        Cluster B
      </text>
      <rect x="370" y="220" width="140" height="70" rx="14" fill="#EEF5F1" stroke="#C5D9CC" strokeWidth="2" />
      <text x="440" y="260" fill="#3D4F58" fontSize="13" textAnchor="middle" fontFamily={font}>
        Cluster C
      </text>
      <rect x="660" y="120" width="160" height="80" rx="16" fill="#ffffff" stroke="#E8D9A8" strokeWidth="2" />
      <text x="740" y="155" fill="#243038" fontSize="14" textAnchor="middle" fontFamily={font}>
        Git (source)
      </text>
      <text x="740" y="175" fill="#6B7C82" fontSize="11" textAnchor="middle" fontFamily={font}>
        monorepo
      </text>
...
export function GitOpsHubSpokeLargeDiagram({
  ...
  return (
    <svg viewBox="0 0 1100 480" role="img" aria-label={title} {...props}>
      <rect width="1100" height="480" fill="#F7FAF8" rx="16" />
      <rect x="40" y="190" width="180" height="100" rx="14" fill="#ffffff" stroke="#E8D9A8" strokeWidth="2" />
      <text x="130" y="230" fill="#243038" fontSize="16" textAnchor="middle" fontFamily={font}>
        Git monorepo
      </text>
      <text x="130" y="255" fill="#6B7C82" fontSize="12" textAnchor="middle" fontFamily={font}>
        source of truth
      </text>
      <rect x="320" y="170" width="200" height="140" rx="14" fill="#ffffff" stroke="#6F8F7E" strokeWidth="2" />
      <text x="420" y="220" fill="#243038" fontSize="16" textAnchor="middle" fontFamily={font}>
        Argo CD Hub
      </text>
      <text x="420" y="245" fill="#3D4F58" fontSize="12" textAnchor="middle" fontFamily={font}>
        mgmt cluster
      </text>
      <text x="420" y="270" fill="#6B7C82" fontSize="11" textAnchor="middle" fontFamily={font}>
        ApplicationSets
      </text>
      <rect x="320" y="40" width="200" height="70" rx="12" fill="#EEF5F1" stroke="#C5D9CC" strokeWidth="2" />
      <text x="420" y="70" fill="#3D4F58" fontSize="13" textAnchor="middle" fontFamily={font}>
        CI · PR diffs only
      </text>
      <text x="420" y="90" fill="#6B7C82" fontSize="11" textAnchor="middle" fontFamily={font}>
        no kubectl to prod
      </text>
      <rect x="700" y="40" width="180" height="90" rx="14" fill="#EEF5F1" stroke="#C5D9CC" strokeWidth="2" />
      <text x="790" y="80" fill="#243038" fontSize="14" textAnchor="middle" fontFamily={font}>
        Spoke A
      </text>
      <text x="790" y="105" fill="#6B7C82" fontSize="11" textAnchor="middle" fontFamily={font}>
        prod · EU-west
      </text>
      <rect x="700" y="170" width="180" height="90" rx="14" fill="#EEF5F1" stroke="#C5D9CC" strokeWidth="2" />
      <text x="790" y="210" fill="#243038" fontSize="14" textAnchor="middle" fontFamily={font}>
        Spoke B
      </text>
      <text x="790" y="235" fill="#6B7C82" fontSize="11" textAnchor="middle" fontFamily={font}>
        prod · EU-central
      </text>
      <rect x="700" y="300" width="180" height="90" rx="14" fill="#EEF5F1" stroke="#C5D9CC" strokeWidth="2" />
      <text x="790" y="340" fill="#243038" fontSize="14" textAnchor="middle" fontFamily={font}>
        Spoke C
      </text>
      <text x="790" y="365" fill="#6B7C82" fontSize="11" textAnchor="middle" fontFamily={font}>
        prod · EU-north
      </text>
      <rect
        x="940"
      ...
      <text x="1000" y="230" fill="#6B7C82" fontSize="10" textAnchor="middle" fontFamily={font}>
        secrets
      </text>
...
export function ArchitectureFigure({ id, large = false }: { id: string; large?: boolean }) {
  const className = "h-auto w-full min-w-[640px]";
  if (id === "gitops-hub-spoke" && large) {
    return <GitOpsHubSpokeLargeDiagram className={className} />;
  }
  switch (id) {
    case "gitops-hub-spoke":
      return <GitOpsHubSpokeDiagram className={className} />;
